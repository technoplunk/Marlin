...
#define STRING_CONFIG_H_AUTHOR "(Derek, Precalibration 1)" // Who made the changes.
...
#define PID_MAX BANG_MAX // limits current to nozzle while PID is active (see PID_FUNCTIONAL_RANGE below); 255=full current
  ...
  // Ultimaker
  #define  DEFAULT_Kp 38.07
  #define  DEFAULT_Ki 3.80
  #define  DEFAULT_Kd 95.44
...
//#define PID_BED_DEBUG // Sends debug data to the serial port.
  ...
  #define  DEFAULT_bedKp 119.37
  #define  DEFAULT_bedKi 18.97
  #define  DEFAULT_bedKd 187.76
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {81.103,81.334,2560,595.280818}  // default steps per unit for Ultimaker
